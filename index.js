...
const SUB_PATH = process.env.SUB_PATH || 'leaflow';       // 订阅sub路径，默认为sub,例如：https://google.com/sub
const UUID = process.env.UUID || '22d73127-cc6a-4163-8081-2cafd693828c';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
